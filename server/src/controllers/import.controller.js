...
async function importItems(req, res) {
  ...
  // Import everything valid in one transaction: create each item, and if it
  // has an opening quantity, record an audit-trail STOCK_IN movement for it
  // rather than just materializing a number.
